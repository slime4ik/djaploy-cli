...
[![ci](https://github.com/slime4ik/djaploy-cli/actions/workflows/ci.yml/badge.svg)](https://github.com/slime4ik/djaploy-cli/actions/workflows/ci.yml)

Prepares a Linux server for running a Dockerised app: current packages, fail2ban,
Docker with registry mirrors, and a separate unprivileged user for deployments.

**No account. No signup. Nothing is sent anywhere.**
...
Full options: `djaploy --help`. Language: `--lang ru`, or `DJAPLOY_LANG=ru`.
